...
(function () {
    const translations = {
        ...
        "es": {
            "title": "pepstudio - Calculadoras y herramientas gratuitas",
            "subtitle": "Calculadoras y convertidores 100% gratuitos y precisos",
            "age_calc_title": "Calculadora de Edad",
            "select_language": "Seleccionar Idioma",
            "doc_system_badge": "Guía de Usuario y Especificaciones",
            "doc_main_title": "Documentación Técnica y Guía del Sistema Pepstudio",
            "doc_main_subtitle": "Una guía completa sobre nuestro motor de cálculo de precisión, modelos matemáticos y arquitectura de privacidad.",
            "doc_sec1_title": "1. Arquitectura del Sistema y Privacidad",
            "doc_sec1_p1": "Todas las herramientas de pepstudio están diseñadas con un paradigma centrado en el cliente. El 100% de la lógica se ejecuta en su navegador local.",
            "doc_sec1_p2": "Sin latencia y con privacidad garantizada: sus datos nunca salen de su dispositivo.",
            "doc_sec2_title": "2. Modelos de Cálculo y Especificaciones Matemáticas",
            "doc_sec3_title": "3. Modo sin conexión y PWA",
            "doc_sec3_p": "Totalmente compatible con los estándares de almacenamiento en caché de Aplicaciones Web Progresivas (PWA).",
            "doc_back_btn": "Volver a Herramientas Pepstudio"
        },
        "fr": {
            "title": "pepstudio - Calculateurs et outils gratuits",
            "select_language": "Choisir la langue",
            "doc_system_badge": "Manuel d'utilisation et spécifications",
            "doc_main_title": "Documentation Technique et Guide du Système Pepstudio",
            "doc_sec1_title": "1. Architecture Système et Confidentialité",
            "doc_sec2_title": "2. Modèles de Calcul et Spécifications Mathématiques",
            "doc_sec3_title": "3. Mode Hors Ligne et PWA",
            "doc_back_btn": "Retour aux Outils Pepstudio"
        },
        "de": {
            "title": "pepstudio - Kostenlose Rechner und Werkzeuge",
            "select_language": "Sprache auswählen",
            "doc_system_badge": "Benutzerhandbuch & Spezifikationen",
            "doc_main_title": "Technische Dokumentation & Systemhandbuch Pepstudio",
            "doc_sec1_title": "1. Systemarchitektur & Datenschutz",
            "doc_sec2_title": "2. Berechnungsmodelle & Mathematische Spezifikationen",
            "doc_sec3_title": "3. Offline-Modus & PWA",
            "doc_back_btn": "Zurück zu Pepstudio Werkzeugen"
        },
        "hi": {
            "title": "pepstudio - मुफ्त कैलकुलेटर और टूल",
            "select_language": "भाषा चुनें",
            "doc_system_badge": "उपयोगकर्ता निर्देशिका एवं विनिर्देशन",
            "doc_main_title": "पेपस्टायदे तकनीकी दस्तावेज़ एवं सिस्टम गाइड",
            "doc_sec1_title": "1. सिस्टम आर्किटेक्चर एवं गोपनीयता",
            "doc_sec2_title": "2. गणना मॉडल एवं गणितीय विनिर्देशन",
            "doc_sec3_title": "3. ऑफ़लाइन मोड एवं PWA",
            "doc_back_btn": "पेपस्टायदे टूल्स पर वापस जाएँ"
        },
        "zh": {
            "title": "pepstudio - 免费在线计算器和实用工具",
            "select_language": "选择语言",
            "doc_system_badge": "用户指南与系统规范",
            "doc_main_title": "Pepstudio 技术文档与系统指南",
            "doc_main_subtitle": "关于我们高精度计算引擎、数学模型、客户端隐私架构及工具套件功能的全面指南。",
            "doc_sec1_title": "1. 系统架构与零知识隐私",
            "doc_sec1_p1": "pepstudio 套件中的每个工具都采用客户端优先范式构建。计算逻辑 100% 在您的本地浏览器中运行。",
            "doc_sec1_p2": "数据绝不会离开您的设备，提供零延迟与高强度隐私保障。",
            "doc_sec2_title": "2. 计算模型与数学规范",
            "doc_sec3_title": "3. 离线模式与 PWA 功能",
            "doc_sec3_p": "全面兼容 PWA 缓存标准，支持离线状态下顺畅使用。",
            "doc_back_btn": "返回 Pepstudio 工具套件"
        }
    };
